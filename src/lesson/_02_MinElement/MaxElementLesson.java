...
public class MaxElementLesson implements Lesson {
    
   private final static String resourcesDir = "/lesson/_02_MinElement/resources/";
    ...
    public MaxElementLesson(MainClass mainClass) {
